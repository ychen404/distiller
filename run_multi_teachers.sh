...
#  --student resnet8 --dataset cifar10 --mode multiteacher_kd \
#  --num_users 2 --edge_distillation 1 --workspace num_users_2_epochs_2_comm_10_edge_distil_1 --log=DEBUG

  python3 my_main.py --epochs 10 --communication_round 1 --edge resnet8 --batch-size 1024 \
 --cloud resnet8 --dataset cifar10 --mode multiteacher_kd --frac 1 \
 --num_users 2 --edge_distillation 0 --workspace test_round --log debug